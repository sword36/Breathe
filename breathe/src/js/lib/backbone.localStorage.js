...
Backbone.getSyncMethod = function(model, options) {
  ...
  function doubleSync(method, model, options) {

    Backbone.getSyncMethod(model, options).apply(this, [method, model, options]);
  }
...
Backbone.sync = function(method, model, options) {
  ...
  if (method != "read" && Backbone.storageMode == "online" && (options.doubleSync || method == "update")) {
    var tempOpt = options;
    //if method update, than options without "doubleSync" and we should add it
    if (!options.doubleSync) {
      tempOpt = clone(options);
      tempOpt.doubleSync = true;
    }

    doubleSync.apply(this, [method, model, tempOpt]);
